...
**Prostar** is a software for the **statistical analysis of quantitative data** from discovery proteomics experiments. Its **user-friendly**, [Shiny](https://shiny.rstudio.com/){target="_blank"}-based interface provides an **accessible workflow** for exploring, processing, and performing differential analysis of **proteomics datasets**.
...
<span class="turquoise homeNews">**25/11/2024**</span>
