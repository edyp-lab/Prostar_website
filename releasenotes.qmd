...
[1.38.1] (25/11/2024)
  ...
  * Bug fixed in the swap conditions tool indice of the Hypothesis Test process 
...
[1.36.3] (05/10/2024)
  ...
  * Bug fixed in the Convert tool when clicking on "Convert Data": sometimes the following error occurred: Error in [.data.frame(tmp.df, , ‘Sample.name’) : undefined columns selected.
