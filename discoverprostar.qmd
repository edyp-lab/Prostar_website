...
## Software
1. [**Zero-install**](/download.html#zero-install)  
...
2. [**Stand-alone Bioconductor install**](/download.html#bioconductor-installs)  
...
This more advanced type of install is detailed in the [user manual](/ressources.html).
